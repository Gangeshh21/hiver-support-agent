...
Thirty cases were successfully evaluated.
...
Important: These scores are based on a 30-case evaluation sample and should not be treated as production-level estimates.
...
LLM reply evaluation was run on 30 cases.

Human-vs-LLM judge agreement was reviewed on the same 30 cases.
